...
async def on_ready():
    ...
    activity = discord.Activity(type=discord.ActivityType.listening, name="Made By ByApple_") # Botun oynuyor kısmıdır
...
async def on_message(message):
    ...
    if message.content.startswith("!sms "):
        ...
        if len(telno) == 10:
            ...
            embed.set_footer(text="Made By ByApple_") # footer
            ...
            embed.set_footer(text="Bu mesaj 30 saniye sonra otomatik olarak silinecektir. | Made By ByApple_") ## KOMUTU KULLANANA ÖZELDEN MESAJ AT VE 30 SANİYE SONRA SİL
